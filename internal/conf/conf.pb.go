...
type Server struct {
	...
	Ws            *Server_Websocket      `protobuf:"bytes,4,opt,name=ws,proto3" json:"ws,omitempty"`
	Mqtt          *Server_MQTT           `protobuf:"bytes,5,opt,name=mqtt,proto3" json:"mqtt,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\brabbitmq\x18\x03 \x01(\v2\x1b.kratos.api.Server.RabbitMQR\brabbitmq\x12,\n" +
	"\x02ws\x18\x04 \x01(\v2\x1c.kratos.api.Server.WebsocketR\x02ws\x12+\n" +
	"\x04mqtt\x18\x05 \x01(\v2\x17.kratos.api.Server.MQTTR\x04mqtt\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\bRabbitMQ\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x1ah\n" +
	"\tWebsocket\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x12\x12\n" +
	"\x04path\x18\x02 \x01(\tR\x04path\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x1a\x1a\n" +
	"\x04MQTT\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\"\xdd\x02\n" +
	"\x04Data\x125\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeoutB7Z5github.com/wyuhsin/web-template-go/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Server_RabbitMQ)(nil),     // 5: kratos.api.Server.RabbitMQ
	(*Server_Websocket)(nil),    // 6: kratos.api.Server.Websocket
	(*Server_MQTT)(nil),         // 7: kratos.api.Server.MQTT
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Server.rabbitmq:type_name -> kratos.api.Server.RabbitMQ
	6,  // 5: kratos.api.Server.ws:type_name -> kratos.api.Server.Websocket
	7,  // 6: kratos.api.Server.mqtt:type_name -> kratos.api.Server.MQTT
	...
	10, // 11: kratos.api.Server.Websocket.timeout:type_name -> google.protobuf.Duration
